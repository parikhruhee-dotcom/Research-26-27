# GPU-tier status — what ran locally vs. what is Colab-deferred

Detected compute tier on this build: **CPU**
(2 CPU cores, 7.76 GB RAM,
CUDA available: False). Full profile:
...
- **What ran on this machine:** NOT AlphaFold2-multimer. The brief's own
  ...
  ESM-2 (`esm2_t6_8M_UR50D`, ~30 MB) single-pass
...
executed, not substituted), the 10
